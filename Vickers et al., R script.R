...
p8 <- ggplot(largedensity, aes(x=value, colour=Season)) + 
  ...
  theme_pubr() +
  labs(x = "Pairwise distance", y = "Density") +
  theme(legend.position="bottom",axis.text = element_text(size= 18), axis.title = element_text(size=20), legend.text=element_text(size=20),legend.title=element_blank()) +
  scale_x_continuous(
    breaks = seq(0, 2, 1),
    limits=c(0, 2)) +
  ylim(c(0,5))
...
p2 <- ggplot(alldensity, aes(x=value, colour=Season)) + 
  ...
  theme_pubr() +
  labs(x = "Pairwise distance", y = "Density") +
  theme(legend.position="none",axis.text = element_text(size= 18), axis.title = element_text(size=18), legend.text=element_text(size=12),legend.title=element_text(size=12)) +
  scale_x_continuous(
    breaks = seq(0, 2, 1),
    limits=c(0, 2)) +
  ylim(c(0,5))
...
p4 <- ggplot(smalldensity, aes(x=value, colour=Season)) + 
  ...
  theme_pubr() +
  labs(x = "Pairwise distance", y = "Density") +
  theme(legend.position="none",axis.text = element_text(size= 18), axis.title = element_text(size=18), legend.text=element_text(size=12),legend.title=element_text(size=10)) +
  scale_x_continuous(
    breaks = seq(0, 2, 1),
    limits=c(0, 2)) +
  ylim(c(0,5))
...
p8 <- ggplot(largedensity, aes(x=value, colour=Season)) + 
  ...
  theme_pubr() +
  labs(x = "Pairwise distance", y = "Density") +
  theme(legend.position="bottom",axis.text = element_text(size= 18), axis.title = element_text(size=18), legend.text=element_text(size=10),legend.title=element_blank()) +
  scale_x_continuous(
    breaks = seq(0, 2, 1),
    limits=c(0, 2)) +
  ylim(c(0,5))
...
plot3 <- ggdraw() +
  ...
  draw_plot_label(label = c("i", "ii"), size = 20, x = c(0, .5), y = c(1,1))
plot
ggsave("Figure_1.pdf", plot = plot3, dpi = 600, width=20)
